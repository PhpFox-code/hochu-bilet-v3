...
<div class="sideBar sideBarFixed sideBarSize">
    <div class="mCustomScrollbar fluid sideBarScrollSize">
        <div class="sideBarContent">
            <ul class="navLeft">
                <?php foreach ( (array) $result[0] as $obj ): ?>
                    <?php if ( isset( $result[ $obj->id ] ) AND count( $result[ $obj->id ] ) ): ?>
                        ...
                        <li class="<?php echo $check ? 'subMenuOpen' : NULL; ?>">
                            <a class="subToggle <?php echo $check ? 'cur' : NULL; ?>" href="/backend/<?php echo $obj->link; ?>">
                            ...
                            <ul class="subMenu" <?php echo $check ? 'style="height:'.(count($result[$obj->id]) * 43).'px;"' : NULL; ?>>
                                <?php foreach ( $result[ $obj->id ] as $_obj ): ?>
                                    ...
                                    <?php endif; ?>
                                    <li>
                                        <a class="<?php echo $check ? 'cur' : ''; ?>" href="/backend/<?php echo $_obj->link; ?>">
                    ...
                    <?php else: ?>
                        ...
                        <?php endif; ?>
                        <li>
                            <a class="<?php echo $check ? 'cur' : NULL; ?>" href="/backend/<?php echo $obj->link; ?>">
                                <i class="<?php echo $obj->icon; ?>"></i>
                                <?php echo $obj->name; ?>
