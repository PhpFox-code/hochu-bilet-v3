                        ...
                        <tbody>
                            <?php foreach ( $result as $obj ): ?>
                                <tr data-id="<?php echo $obj->id; ?>">
                                    ...
                                    <td>
                                        <a href="/product/<?php echo $obj->alias; ?>" target="_blank">Перейти</a>
                                    </td>
                                    <td>
                                        <a href="/backend/groups/edit/<?php echo $obj->catalog_tree_id; ?>" target="_blank"><?php echo $obj->catalog_tree_name; ?></a>
                                    </td>
                                    <td width="45" valign="top" class="icon-column status-column">
                                        <a href="#" data-id="<?php echo $obj->id ?>" data-field="top" class="changeField"><?php echo $obj->top ? 'Да' : 'Нет'; ?></a>
                                    </td>
                                    <td width="45" valign="top" class="icon-column status-column">
                                        <a href="#" data-id="<?php echo $obj->id ?>" data-field="new" class="changeField"><?php echo $obj->new ? 'Да' : 'Нет'; ?></a>
                                    </td>
                                    <td width="45" valign="top" class="icon-column status-column">
