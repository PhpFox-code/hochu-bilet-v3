<?php
    ...
    class News extends \Backend\Modules\Base {

        public $tpl_folder = 'News';
        ...
        function before() {
            ...
            $this->setBreadcrumbs('Новости', 'backend/'.Route::controller().'/index');
        ...
        function indexAction () {
            ...
            if( $date_s ) { $result->where( 'date', '>=', $date_s ); }
            if( $date_po ) { $result->where( 'date', '<=', $date_po + 24 * 60 * 60 - 1 ); }
