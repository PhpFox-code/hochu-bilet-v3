<?php
    namespace Backend\Modules\Brone\Controllers;
    ...
    class Brone extends \Backend\Modules\Base {

        public $tpl_folder = 'Brone';
        public $tablename  = 'brone';
        public $limit;
        ...
        function editAction () {
            ...
            $this->_seo['h1'] = 'Просмотр';
            $this->_seo['title'] = 'Просмотр';
            $this->setBreadcrumbs('Просмотр', 'backend/'.Route::controller().'/edit/'.(int) Route::param('id'));
