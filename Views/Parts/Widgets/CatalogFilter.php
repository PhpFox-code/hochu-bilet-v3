...
<form action="">
    <ul class="main_filt">
            ...
            <li data-key="model">
                ...
                <ul class="model content mCustomScrollbar">
                    <?php foreach ($models as $obj): ?>
                        <li data="<?php print_r($filter['model']); ?>" datai="<?php print_r($obj); ?>"><?php echo Modules\Catalog\Models\Filter::generateInput($filter, $obj, 'model'); ?></li>
                    <?php endforeach ?>
                </ul>
            </li>
        <?php endif; ?>
        ...
        <?php if (count($sizes)): ?>
            <li data-key="size">
                <div class="filt_title">размер</div>
                <ul class="razmer content mCustomScrollbar">
                    <?php foreach ($sizes as $obj): ?>
                        <li><?php echo Modules\Catalog\Models\Filter::generateInput($filter, $obj, 'size'); ?></li>
                    <?php endforeach ?>
                </ul>
            </li>
        <?php endif; ?>
